...
import useGenericComponentRef from '@/hooks/useGenericComponentRef'
...
const toDetail = () => {
  router.push(
    `/proTable/useProTable/detail/${Math.random()}?params=detail-page`
  )
}

// 获取 ProTable 元素，调用其获取刷新数据方法（还能获取到当前查询参数，方便导出携带参数）
const proTable = useGenericComponentRef(ProTable)
